...
export type FORECAST = {
  timelines: {
    hourly: {
      time: string;
      values: HOURLY_TIMELINE_VALUES;
    }[];
    minutly: {
      time: string;
      values: MINUTLY_TIMELINE_VALUES;
    }[];
    daily: {
      time: string;
      values: DAILY_TIMELINE_VALUES;
    }[];
  };
  location: {
    lat: number;
